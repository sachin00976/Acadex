...
const AddStudent = () => {
  ...
  return (
    <form onSubmit={addStudentProfile} className="w-[70%] flex justify-center items-center flex-wrap gap-6 mx-auto mt-10">
        <div className='w-[40%]'>
      ...
      <div className='w-[40%]'>
            ...
            <select id="semester" className='px-2 bg-blue-50 py-3 rounded-sm text-base w-full accent-blue-700 mt-1' value={data.semester}
      ...
      <div className='w-[40%]'>
        ...
        <select  id="branch" className='px-2 bg-blue-50 py-3 rounded-sm text-base w-full accent-blue-700 mt-1' value={data.branch}
