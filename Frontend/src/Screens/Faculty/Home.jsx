                ...
                <div className=" mx-auto">
                    ...
                    >
                        Student Info
                            ...
                            <li
                        className={`text-center rounded-sm px-2 py-2 w-1/5 cursor-pointer ease-linear duration-300 hover:ease-linear hover:duration-300 hover:transition-all transition-all ${
